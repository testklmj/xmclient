...
var CutCardPop = BasePopup.extend({
    ...
    selfRender:function(){
        ...
        if(this.isView){
            ...
            this.Image_11.loadTexture("res/ui/ddz/images/img_qiepai_2.png");
        ...
        var max = RoomModel.wanfa==15 ? 45 : 48;
        var gap = RoomModel.wanfa==15 ? 21 : 20;
        for(var i=0;i<max;i++){
            var texture = (i<27) ? "res/ui/ddz/images/cut_card_4.png" : "res/ui/ddz/images/cut_card_3.png";
    ...
    onProg:function(event){
        ...
        for(var i=0;i<this.cards.length;i++){
            ...
            if(i<data){
                card.setTexture("res/ui/images/ddz/cut_card_4.png");
                if(card.x>maxX)
                    maxX=card.x;
            }else{
                card.setTexture("res/ui/images/ddz/cut_card_3.png")
            }
        }
        var max =  102+maxX+20;
        max = max<110 ? 110 : max;
