...
var ClubPhzRecallDetailItem = ccui.Widget.extend({
    ...
    onHuiFang:function(){
        ...
        for (var i = 0; i < PopupManager.popupList.length; i++) {
            ...
            } else if (PopupManager.popupList[i]["constructor"] == ClubPhzRecallDetailPop) {
       ...
       if(this.data.playType==PHZGameTypeModel.SYZP || this.data.playType==PHZGameTypeModel.SYBP || this.data.playType==PHZGameTypeModel.LDFPF ) {
