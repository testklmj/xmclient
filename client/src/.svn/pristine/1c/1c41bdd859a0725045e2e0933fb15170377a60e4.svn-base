...
var CSMJRoom = BaseRoom.extend({
    ...
    selfRender:function(){
        ...
        this.button_wanfa =  new ccui.Button("res/ui/mj/zzmjRoom/wanfa.png","","",ccui.Widget.LOCAL_TEXTURE);
        ...
        if(isShow){
            if(!this.piaoBtnNode){
                ...
                for(var i = 0;i<imgArr.length;++i){
                    ...
                    var btn = new ccui.Button(img,"","",ccui.Widget.LOCAL_TEXTURE);
                    btn.setTag(i);
                    btn.setScale(0.6);
    ...
    onClickPiaoFenBtn:function(sender){
        sySocket.sendComReqMsg(206,[sender.getTag()]);
    },
    ...
    refreshButton:function(selfAct){
        ...
        if(selfAct.length>0){
            ...
            // [0,0,1,1,] 0 1 2 3
            // if (selfAct[0] == 1 && selfAct[1] == 1){
            //     textureMap[0] = {t:"res/ui/mj/zzmjRoom/mj_btn_peng.png",v:2};
            //     textureMap[1] = {t:"res/ui/mj/zzmjRoom/mj_btn_hu.png",v:1};
            //     if (selfAct[5] == 1){
            //         textureMap[5] = {t:"res/ui/mj/zzmjRoom/mj_btn_hu.png",v:1};
            //         textureMap[1] = {t:"res/ui/mj/zzmjRoom/mj_btn_bu.png",v:7};
            //     }
            // }
            var rIndex=0;
            var hasHu = false;
