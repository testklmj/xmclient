...
var ClubCreditFindDetailItem = ccui.Widget.extend({
    ctor:function(data,root,index){
        ...
        Label_id.setPosition(cc.p(-255+Image_bg.getAnchorPointInPoints().x, 0+Image_bg.getAnchorPointInPoints().y));
        Image_bg.addChild(Label_id);
        var Label_name=this.Label_name= UICtor.cLabel("100",25,cc.size(0,0),cc.color(126,49,2),0,0);
        Label_name.setPosition(cc.p(-84+Image_bg.getAnchorPointInPoints().x, 0+Image_bg.getAnchorPointInPoints().y));
        Image_bg.addChild(Label_name);
        var Label_num=this.Label_num= UICtor.cLabel("100",25,cc.size(0,0),cc.color(126,49,2),0,0);
        Label_num.setPosition(cc.p(140+Image_bg.getAnchorPointInPoints().x, 0+Image_bg.getAnchorPointInPoints().y));
