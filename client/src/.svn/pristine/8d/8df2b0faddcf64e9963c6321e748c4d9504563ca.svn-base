...
var BBTPlayBackModel = {
	...
	init:function(message,isDaiKai){
		...
		//cc.log("message.play::::::::"+JSON.stringify(message.play))
		//cc.log("message.resList::::::::"+JSON.stringify(message.resList))
		//cc.log("message.closingMsg::::::::"+JSON.stringify(message.closingMsg))
		...
		if(!this.getPlayerVo() || TotalRecordModel.isDaiKai){
