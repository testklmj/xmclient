...
var CreateRoomPHZ = BasePopup.extend({
    ...
    displayZhuang:function(){
        if(this.wanfa == PHZGameTypeModel.SYBP) {
            ...
            this.displayKlz();
            this.getWidget("txt_jushu_1").setString("不限");
            ...
            this.getWidget("txt_jushu_1").setString("1局");
    ...
    updateCostDiamond:function(){
        ...
        if(this.wanfa == PHZGameTypeModel.SYBP){//剥皮
        ...
        }else if (this.wanfa == PHZGameTypeModel.SYZP){//字牌
            if(this.jushu == 10){
                diamondAA = 8;
                diamondFangzhu = 20;
                diamondQunzhu = 20;
